...
export function DashboardStats({
    ...
    return (
        <section className="relative">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hidden md:hidden -mx-4 px-4 snap-x snap-mandatory pr-8">
                {/* Wallet Balance */}
                <Card className="group flex w-[72vw] max-w-[260px] shrink-0 snap-center flex-col gap-3 p-3.5">
                ...
                {/* Shame Score */}
                <Card className="group relative flex w-[72vw] max-w-[260px] shrink-0 snap-center flex-col gap-3 overflow-hidden p-3.5">
            ...
            {/* Desktop: standard 4-col grid (hidden on mobile) */}

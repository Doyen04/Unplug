...
export default async function DashboardSettingsPage({
    ...
    return (
        <div className="max-w-220 mx-auto pt-6 px-6 max-sm:px-4 space-y-4">
            ...
            {hasInvalidProfileInput && (
                <Badge variant="danger" className="w-full justify-center py-2">
                    Input error: Check name and email requirements.
                </Badge>
            )}
            {hasProfileUpdateFailed && (
                <Badge variant="danger" className="w-full justify-center py-2">
            ...
            {hasUnsubscribeFailed && (
                <Badge variant="danger" className="w-full justify-center py-2">
                    Error: Could not cancel Pro plan.
                </Badge>
            )}
            {hasUnsubscribed && (
                <Badge variant="success" className="w-full justify-center py-2">
                    Success: Pro plan cancelled.
                </Badge>
            )}
